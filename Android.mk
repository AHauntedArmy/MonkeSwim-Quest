...
include $(PREBUILT_SHARED_LIBRARY)
# adding monkemaploader dependency
include $(CLEAR_VARS)
LOCAL_MODULE := monkemaploader
LOCAL_EXPORT_C_INCLUDES := MapLoader/MonkeMapLoader
LOCAL_SRC_FILES := MapLoader/libmonkemaploader.so
include $(PREBUILT_SHARED_LIBRARY)

include $(CLEAR_VARS)
LOCAL_MODULE := MonkeSwim-Quest
...
LOCAL_SHARED_LIBRARIES += monkemaploader
LOCAL_LDLIBS += -llog
LOCAL_CFLAGS += -I'extern/libil2cpp/il2cpp/libil2cpp' -DID='"MonkeSwim-Quest"' -DVERSION='"1.0.0"' -I'./shared' -I'./extern' -I'./MapLoader' -I'./MapLoader/MonkeMapLoader/include' -isystem'extern/monkecodegen/include'
