...
LOCAL_LDLIBS += -llog
LOCAL_CFLAGS += -I'extern/libil2cpp/il2cpp/libil2cpp' -DID='"MonkeSwim-Quest"' -DVERSION='"0.1.0"' -I'./shared' -I'./extern' -I'./MapLoader' -I'./MapLoader/MonkeMapLoader/include' -isystem'extern/monkecodegen/include'
